...
|---|-------|-----------------|------|----------|---------------|
| 1 | Introduction | Commitments.lean | C | ✅ Full | 8 commitment axioms |
...
| 8 | Redeemability | Commitments.lean | C | ✅ Axiom | `RedeemabilityExternal` |
...
**Tier:** C (Spec/Interface) — These are design requirements, not derived.

**Lean Artifacts:**

| Commitment | Axiom | File:Line | Tier |
|------------|-------|-----------|------|
| C1: Traction/Authorization split | `TractionAuthorizationSplit` | Commitments.lean:66 | C |
| C2: No global ledger | `NoGlobalLedgerTradeoff` | Commitments.lean:92 | C |
...
| C4: Redeemability external | `RedeemabilityExternal` | Commitments.lean:132 | C |
| C5: Export gating | `reliable_implies_export` | Commitments.lean:154 | C |
| C6: Repair loop | `RepairLoopExists` | Commitments.lean:182 | C |
| C7: Header asymmetry | `HeaderPreservationAsymmetry` | Commitments.lean:363 | C |
| C8: Temporal validity | `TemporalValidity` | Commitments.lean:378 | C |
...
| `Entrenched` | `def` | Basic.lean:142 | C |
...
| Artifact | Type | File:Line | Tier |
|----------|------|-----------|------|
| `Validate_B`, `Accept_B`, `Challenge_B`, `Repair_B`, `Revoke_B`, `Restore_B`, `Export_B_C`, `Import_C` | `axiom` | Bank.lean:138-183 | C |
...
**Tier:** C (Spec/Interface) — These are commitment axioms.

**Lean Artifacts:**

| Artifact | Type | File:Line | Tier |
|----------|------|-----------|------|
| `RedeemabilityExternal` | `axiom` | Commitments.lean:132 | C |
| `ConsensusNotSufficient` | `axiom` | Commitments.lean:143 | C |
...
| `knowledge_B` | `opaque` | Bank.lean:70 | C |
| `deposited` | `opaque` | Bank.lean:73 | C |
...
| `ConcreteSuccessfulSystem` | `def` | Realizer.lean | A |
| `convergence_under_constraints'` | `theorem` | Minimality.lean | A |

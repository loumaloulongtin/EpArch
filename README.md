...
> **Scope note.** EpArch is a framework for determining which architectural mechanisms are *required* under relatable constraint and goal profiles. It is not a claim that every conceivable world or system must instantiate the same mechanisms.

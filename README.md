...
| `ResidualRiskMitigation.lean` | T27 capstone: `ResidualRiskMode` (9 modes), `EpArchMechanism` (11 mechanisms), `Mitigates` relation, `eparch_surface_covers_residual_risk_modes` — every forced risk mode is covered by a prescribed mechanism |
